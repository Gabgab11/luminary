...
// The one client this portal currently serves. If you ever reuse this
// admin dashboard for a second client, give them their own slug and
// their own copy of the portal that points at it.
export const CLIENT_SLUG = "kairos-kreations";
